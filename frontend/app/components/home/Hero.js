...
export default function Hero({ 
  title = "Professional Car Window Tinting Tailored to Your Needs", 
  subtitle = "Premium vehicle window tinting backed by 19+ years of experience." 
}) {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center bg-zinc-950 overflow-hidden py-20 px-4 sm:px-6 lg:px-8 border-b border-zinc-800/60">
      
      {/* Static Background Image with Dark Vignette & Gradient Overlay */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-zinc-800 via-zinc-900/80 to-zinc-950/40 z-10" />
        <div className="absolute inset-0 bg-gradient-to-t from-zinc-800 via-transparent to-zinc-900/60 z-10" />
        <img 
          src="/Requirements/Hero-bg.webp" 
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          >
            ...
            <span className="relative z-10">Over 19+ Years of Master Craftsmanship</span>
          </motion.div>
          ...
          <motion.div 
            variants={fadeInFromBottom} 
            custom={0.8}
            className="pt-6 grid grid-cols-3 gap-4 border-t border-zinc-800/80 max-w-xl text-zinc-400 text-sm"
          >
